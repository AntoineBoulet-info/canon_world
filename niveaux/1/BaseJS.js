$(document).ready(function() {
	...
	function doKeyDown(e) {
		...
		if (e.keyCode == 32 && bloquage == 0) {
			var Repet=setInterval(checkCollisions, 3)
			var boum = $("#boum")[0];
			boum.play();
			...
			$("#canon").animate({top: 955}, 30, 'easeOutExpo');
	...
	function checkCollisions(){
	 ...
	 if (match) {
		 ...
		 $('#boule').css('opacity', '0');
		 document.cookie = "lvl2=true;expires=-1;path=/";
		 document.cookie = "lvl1=true;expires=Thu, 01 Jan 1970 00:00:01 GMT";
