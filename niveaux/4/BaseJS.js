$(document).ready(function() {
  ...
  function murbouge() {
      ...
      if (murpierrebordertopmatch1) {
          $('.murpierre3').stop() ;
          $(".murpierre3").animate({top: '80' + '%'}, 1500, 'linear');
      }

      if (murpierreborderbottommatch1) {
          $('.murpierre3').stop() ;
          $(".murpierre3").animate({top: '0' + '%'}, 1500, 'linear');
      }
    }

	document.addEventListener('keydown', doKeyDown, true);

	$(".murpierre3").animate({top: '100' + '%'}, 1500, 'linear');
	...
	function checkCollisions(){
	  ...
	  var pos10 = getPositions($(".murbois2"));
	  ...
	  var murboisMatch2X = comparePositions(pos2[0], pos10[0]);
	  var murboisMatch2Y = comparePositions(pos2[1], pos10[1]);
	 ...
	 if (match) {
		 ...
		 $('#boule').css('opacity', '0');
		 document.cookie = "lvl5=true;expires=-1;path=/";
		 document.cookie = "lvl4=true;expires=Thu, 01 Jan 1970 00:00:01 GMT";
