$(document).ready(function() {
	...
	function murbouge() {
	  ...
	  if (murpierrebordertopmatch1) {
		  $('.murpierre1').stop()
		  $(".murpierre1").animate({top: '80' + '%'}, 1500, 'linear');
	  }

	  if (murpierreborderbottommatch1) {
		  $('.murpierre1').stop()
		  $(".murpierre1").animate({top: '0' + '%'}, 1500, 'linear');
	}
	}

	document.addEventListener('keydown', doKeyDown, true);

	$(".murpierre1").animate({top: '100' + '%'}, 1500, 'linear');
	...
	function checkCollisions(){
	 ...
	 if (match) {
		 ...
		 $('#boule').css('opacity', '0');
		 document.cookie = "lvl6=true;expires=-1;path=/";
		 document.cookie = "lvl5=true;expires=Thu, 01 Jan 1970 00:00:01 GMT";
