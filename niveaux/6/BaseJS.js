$(document).ready(function() {
	...
	var murbouge=setInterval(murbouge, 0.00000000003)
		...
		function murbouge() {
			  ...
			  var murpierrebordertop1Y = comparePositions(pos5[1], pos7[1]);
			  var murpierreborderbottom1Y = comparePositions(pos6[1], pos7[1]);

			  var murpierrebordertop2Y = comparePositions(pos5[1], pos8[1]);
			  var murpierreborderbottom2Y = comparePositions(pos6[1], pos8[1]);

			  var murpierrebordertopmatch1 =  murpierrebordertop1Y;
			  var murpierreborderbottommatch1 =  murpierreborderbottom1Y;

			  var murpierrebordertopmatch2 =  murpierrebordertop2Y;
			  var murpierreborderbottommatch2 =  murpierreborderbottom2Y;

			  if (murpierrebordertopmatch1) {
				  $('.murpierre1').stop()
				  $(".murpierre1").animate({top: '80' + '%'}, 1000, 'linear');
			  }

			  if (murpierreborderbottommatch1) {
				  $('.murpierre1').stop()
				  $(".murpierre1").animate({top: '0' + '%'}, 1000, 'linear');
			}

			if (murpierrebordertopmatch2) {
				  $('.murpierre2').stop()
				  $(".murpierre2").animate({top: '80' + '%'}, 1000, 'linear');
			  }

			  if (murpierreborderbottommatch2) {
				  $('.murpierre2').stop()
				  $(".murpierre2").animate({top: '0' + '%'}, 1000, 'linear');
			}


			}

			$(".murpierre1").animate({top: '100' + '%'}, 1000, 'linear');
			$(".murpierre2").animate({top: '0' + '%'}, 1000, 'linear');
	...
	function checkCollisions(){
	 ...
	 if (match) {
		 ...
		 document.cookie = "lvl7=true;expires=-1;path=/";
		 document.cookie = "lvl6=true;expires=Thu, 01 Jan 1970 00:00:01 GMT";
	  ...
	  if (tourne == 0 && borderTopMatch && bloquage == 1) {
		  $('#boule').stop()
		  $('#boule').attr('src','../../images/explosion.png');
		  $('#boule').width('10' + '%');
		  $('#boule').animate({ opacity: 0 }, 30);
